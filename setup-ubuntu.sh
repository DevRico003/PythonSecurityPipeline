...
export JenkinsPublicHostname=$(curl -s http://3.71.166.230/latest/meta-data/public-hostname)
export SeleniumPrivateIp=$(curl -s http://3.71.166.230/latest/meta-data/local-ipv4)
